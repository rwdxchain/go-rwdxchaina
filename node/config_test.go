...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "grwd.ipc", false, filepath.Join(os.TempDir(), "grwd.ipc")},
		{"data", "grwd.ipc", false, "data/grwd.ipc"},
		{"data", "./grwd.ipc", false, "./grwd.ipc"},
		{"data", "/grwd.ipc", false, "/grwd.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "grwd.ipc", true, `\\.\pipe\grwd.ipc`},
		{"data", "grwd.ipc", true, `\\.\pipe\grwd.ipc`},
		{"data", `\\.\pipe\grwd.ipc`, true, `\\.\pipe\grwd.ipc`},
	}
