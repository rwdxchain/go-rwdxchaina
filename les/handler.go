...
import (
	...
	"github.com/rwdxchain/go-rwdxchaina/common/mclock"
	...
	"github.com/rwdxchain/go-rwdxchaina/trie"
)
...
func (pm *ProtocolManager) Stop() {
	...
	log.Info("Light Rwdxchain protocol stopped")
}
...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	p.Log().Debug("Light Rwdxchain peer connected", "name", p.Name())
	...
	if err := pm.peers.Register(p); err != nil {
		p.Log().Error("Light Rwdxchain peer registration failed", "err", err)
		return err
	}
	defer func() {
