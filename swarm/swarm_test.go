...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/grwd.ipc",
			endpoint:    "/data/testnet/grwd.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/grwd.ipc",
			endpoint:    "/data/testnet/grwd.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/grwd.ipc",
			endpoint:    "/data/testnet/grwd.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/grwd.ipc",
			endpoint:    "/data/testnet/grwd.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
